...
for (const budget of [0.35, 0.5, 0.65, 0.8, 1.0, 1.2]) {
  for (const range of [0.45, 0.6, 0.72, 0.85, 1.0]) {
    for (const cap of [160, 200, 240, 280, 320]) {
      for (const tangent of [0.35, 0.65, 0.9]) {
        const env = { ...base, BOSS_BUDGET_FACTOR: String(budget), BOSS_RANGE_FACTOR: String(range), BOSS_RANGE_CAP: String(cap), BOSS_TANGENT: String(tangent), BOSS_RADIAL_PULL: '0.012' };
